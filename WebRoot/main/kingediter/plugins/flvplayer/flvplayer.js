...
//                              quality : 'high'
//                          });
                    var html='<script src="kindeditor/plugins/flvplayer/flowplayer/flowplayer-3.2.11.min.js"></script>';
                    html += '<a href="'+url+'" style="display:block;width:'+width+'px;height:'+height+'px;margin-left:auto;margin-right:auto" id="player"></a>';
                    //html+='<script language="JavaScript">flowplayer("player", "kindeditor/plugins/flvplayer/flowplayer/flowplayer-3.2.15.swf");</script>';                 
                    html+='<script language="JavaScript">var player=flowplayer("player","kindeditor/plugins/flvplayer/flowplayer/flowplayer-3.2.16.swf",{plugins:{pseudo:{url:"kindeditor/plugins/flvplayer/flowplayer/flowplayer.pseudostreaming-3.2.12.swf"},controls:{autoHide:{fullscreenOnly:true,hideDelay:2000},height:30,scrubber:true,buttonColor:"rgba(0, 0, 0, 0.9)",buttonOverColor:"#000000",backgroundGradient:"medium",backgroundColor:"#D7D7D7",sliderColor:"#2c2c2c",bufferColor:"#606060",progressColor:"#056e9f",sliderBorder:"1px solid #808080",sliderHeight:20,volumeSliderColor:"#FFFFFF",volumeBorder:"1px solid #808080",timeColor:"#000000",durationColor:"#535353",tooltips:{buttons:true,play:"播放",fullscreen:"全屏",fullscreenExit:"退出全屏",pause:"暂停",mute:"静音",unmute:"取消静音"}}},onStart:function(clip){animate(this,{bottom:31})},onFullscreen:function(){},onFullscreenExit:function(){},onBegin:function(){}});</script>';
