...
<body>
	...
	<div class="publicBox ListBox">
		...
		<div class="ListDetails">
			<ul class="clearfix">
				<%
					List<Cuxiao> cuxiaoList = (List<Cuxiao>)request.getAttribute("cuxiao");
							for(Cuxiao cuxiao : cuxiaoList){
				%>
				<li><a
					href="/huyugo/goods/showGoodsById.do?id=<%=cuxiao.getGoods_id()%>&status=cuxiao">
						...
						<dd>
							...
							<del id="delcuxiao<%=cuxiao.getGoods_id()%>"></del>
							<em>马上抢</em>
						</dd> </a>
				</li>
				<script>getGoodsData("<%=cuxiao.getGoods_id()%>", "cuxiao");
				</script>
				<%
					}
				%>
